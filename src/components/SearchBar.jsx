...
const SearchBar = ({ onSearchClick, onTextInput }) => (
  <div className="search-bar">
    ...
    <button type="submit" value="Serial-Number" onClick={(e) => {onSearchClick(e); document.getElementById('searchInputSerial').value=''}}>Search Serial</button>
    ...
    <button type="submit" value="End-User" onClick={(e) => {onSearchClick(e); document.getElementById('searchInputUser').value=''}}>Search End User</button>
