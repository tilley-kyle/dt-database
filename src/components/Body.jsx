...
const Body = ({ pageToDisplay, searchCriteria, currentResults, totalResults, onSearchClick, onTextInput, onNewMachineInput, newInput, onSubmitData, onMachineClick, onEditClick, modelIDs }) => {
